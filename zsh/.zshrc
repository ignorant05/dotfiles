...
# Man page with nvim instead of nano 
...
alias wdir="cd ~/Documents/WorksWell/"
alias work="cd ~/personal/contributions/"
...
# Default git editor is nvim <3
export GIT_EDITOR="nvim"

# Automatically call tmux per tarminal window
if [ -z "$TMUX" ]; then
  exec tmux
fi

# For zoxide configuration
